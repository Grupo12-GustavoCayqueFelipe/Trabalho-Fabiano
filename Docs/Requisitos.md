# Anexo de Requisitos — EduControll

**Versão:** 1.0
**Documento base:** [Escopo do Projeto](./escopo-do-projeto.md)

**Legenda de prioridade:** 🔴 Obrigatório · 🟡 Importante · ⚪ Desejável
...
| RNF-21 | Acesso a dados pessoais limitado ao mínimo necessário por perfil (LGPD) | 🟡 |
